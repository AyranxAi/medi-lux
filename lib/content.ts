...
export const SYMPTOMS: Symptom[] = [
  { name: "Weight gain", category: "metabolism", signal: "Often metabolic and hormonal — not a willpower problem.", pathway: "functional-medicine", img: "SYM-01", brief: "Cropped at the waist, hands working a trouser button that no longer closes, ivory tailoring, Riviera window behind", tone: "gold" },
  ...
  { name: "Gut issues", category: "metabolism", signal: "The gut and your hormones regulate each other.", pathway: "functional-medicine", img: "SYM-10", brief: "Seated in a linen armchair, one hand at her cheek, the other resting flat on her abdomen, coastal light", tone: "taupe" },
