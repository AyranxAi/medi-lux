...
export const SYMPTOMS: Symptom[] = [
  { name: "Weight gain", category: "metabolism", signal: "Often metabolic and hormonal — not a willpower problem.", pathway: "functional-medicine", img: "SYM-01", brief: "Cropped at the waist, hands working a trouser button that won't close, ivory tailoring, Riviera window behind", tone: "gold" },
  { name: "Fatigue", category: "energy", signal: "When rest doesn’t restore you, hormones may be why.", pathway: "hormone-therapy", img: "SYM-02", brief: "Chin resting on her hand by a bedroom window, gaze drifting, soft daylight", tone: "taupe" },
  { name: "Poor sleep", category: "energy", signal: "Night waking and early waking have hormonal patterns.", pathway: "menopause-care", img: "SYM-03", brief: "Awake against the pillows in low lamplight, hand at her temple, night bedroom", tone: "rose" },
  { name: "Brain fog", category: "energy", signal: "Focus and recall shift with oestrogen — and can shift back.", pathway: "menopause-care", img: "SYM-04", brief: "At a laptop by a balcony window, fingers at her temple, gaze drifted off the screen", tone: "taupe" },
  { name: "Mood changes", category: "energy", signal: "Irritability and flatness can be chemistry, not character.", pathway: "hormone-therapy", img: "SYM-05", brief: "Head resting on her hand on a pale sofa, eyes lowered, flat and far away", tone: "rose" },
  { name: "Low libido", category: "intimacy", signal: "Desire is physiology as much as psychology.", pathway: "hormone-therapy", img: "SYM-06", brief: "In a silk robe by lamplight, hand at the back of her neck, turned inward", tone: "rose" },
  { name: "PMS", category: "hormones", signal: "Severe cycles are a signal, not something to endure.", pathway: "hormone-therapy", img: "SYM-07", brief: "Curled into the sofa in linen, both hands pressed to her lower abdomen, brow drawn", tone: "gold" },
  { name: "Hot flashes", category: "hormones", signal: "The classic signal — and one of the most treatable.", pathway: "menopause-care", img: "SYM-08", brief: "Close on the neck and décolletage, hand at her throat, skin flushed, warm afternoon light", tone: "gold" },
  { name: "Hair thinning", category: "intimacy", signal: "Hair follows hormones, thyroid, and nutrition.", pathway: "functional-medicine", img: "SYM-09", brief: "At the mirror, both hands parting her hair to look at the scalp, soft bathroom light", tone: "gold" },
  { name: "Gut issues", category: "metabolism", signal: "The gut and your hormones regulate each other.", pathway: "functional-medicine", img: "SYM-10", brief: "Seated by a Riviera window, both hands resting over a bloated stomach, ivory blouse", tone: "taupe" },
  { name: "Skin ageing", category: "intimacy", signal: "Collagen and skin quality respond to regenerative care.", pathway: "peptide-regenerative", img: "SYM-11", brief: "Silver-haired woman lifting both hands to her jaw and neck, luminous unretouched skin", tone: "rose" },
  { name: "PCOS / cycle irregularity", category: "hormones", signal: "Irregular cycles deserve investigation, not dismissal.", pathway: "hormone-therapy", img: "SYM-12", brief: "Sitting on the bed in a robe, one hand at her cheek, the other low on her abdomen", tone: "taupe" },
];
